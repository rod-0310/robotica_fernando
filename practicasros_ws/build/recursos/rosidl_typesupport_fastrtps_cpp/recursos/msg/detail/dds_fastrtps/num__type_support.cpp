...
#include "recursos/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = recursos::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const recursos::msg::Num *>(
    untyped_ros_message);
...
{
  return &recursos::msg::typesupport_fastrtps_cpp::_Num__handle;
}
