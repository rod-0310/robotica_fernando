...
#include "recursos/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const recursos::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  recursos::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = recursos::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const recursos::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<recursos::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &recursos::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, recursos, msg, Sphere)() {
  return &recursos::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
