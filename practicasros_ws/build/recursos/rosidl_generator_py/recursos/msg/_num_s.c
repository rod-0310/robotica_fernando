...
bool recursos__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("recursos.msg._num.Num", full_classname_dest, 21) == 0);
  }
  recursos__msg__Num * ros_message = _ros_message;
  {  // num
  ...
  {  // two
    ...
    assert(PyLong_Check(field));
    ros_message->two = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * recursos__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("recursos.msg._num");
  ...
  {  // two
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->two);
    {
