...
static const _Kinematics_Request_type_support_symbol_names_t _Kinematics_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, examen_interface, srv, Kinematics_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, examen_interface, srv, Kinematics_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, examen_interface, srv, Kinematics_Request)() {
  return &::examen_interface::srv::rosidl_typesupport_c::Kinematics_Request_message_type_support_handle;
}
...
static const _Kinematics_Response_type_support_symbol_names_t _Kinematics_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, examen_interface, srv, Kinematics_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, examen_interface, srv, Kinematics_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, examen_interface, srv, Kinematics_Response)() {
  return &::examen_interface::srv::rosidl_typesupport_c::Kinematics_Response_message_type_support_handle;
}
...
static const _Kinematics_type_support_symbol_names_t _Kinematics_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, examen_interface, srv, Kinematics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, examen_interface, srv, Kinematics)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, examen_interface, srv, Kinematics)() {
  return &::examen_interface::srv::rosidl_typesupport_c::Kinematics_service_type_support_handle;
}
