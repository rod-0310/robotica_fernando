...
#include "examen_interface/srv/detail/kinematics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const examen_interface::srv::Kinematics_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  examen_interface::srv::Kinematics_Request & ros_message)
{
  // Member: theta1
  cdr >> ros_message.theta1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = examen_interface::srv::Kinematics_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const examen_interface::srv::Kinematics_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<examen_interface::srv::Kinematics_Request *>(
    untyped_ros_message);
...
{
  return &examen_interface::srv::typesupport_fastrtps_cpp::_Kinematics_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, examen_interface, srv, Kinematics_Request)() {
  return &examen_interface::srv::typesupport_fastrtps_cpp::_Kinematics_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_examen_interface
cdr_serialize(
  const examen_interface::srv::Kinematics_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pose
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  examen_interface::srv::Kinematics_Response & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = examen_interface::srv::Kinematics_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const examen_interface::srv::Kinematics_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<examen_interface::srv::Kinematics_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &examen_interface::srv::typesupport_fastrtps_cpp::_Kinematics_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, examen_interface, srv, Kinematics_Response)() {
  return &examen_interface::srv::typesupport_fastrtps_cpp::_Kinematics_Response__handle;
}
...
{
  return &examen_interface::srv::typesupport_fastrtps_cpp::_Kinematics__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, examen_interface, srv, Kinematics)() {
  return &examen_interface::srv::typesupport_fastrtps_cpp::_Kinematics__handle;
}
