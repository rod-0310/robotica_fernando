...
#include "examen_interface/msg/detail/num__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // nom
#include "rosidl_runtime_c/string_functions.h"  // nom

// forward declare type support functions


using _Num__ros_msg_type = examen_interface__msg__Num;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: nom
  {
    const rosidl_runtime_c__String * str = &ros_message->nom;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: nom
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->nom.data) {
      rosidl_runtime_c__String__init(&ros_message->nom);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->nom,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'nom'\n");
      return false;
    }
  }
...
size_t get_serialized_size_examen_interface__msg__Num(
  const void * untyped_ros_message,
...
static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_examen_interface__msg__Num(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_examen_interface
size_t max_serialized_size_examen_interface__msg__Num(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = examen_interface__msg__Num;
    is_plain =
      (
...
static size_t _Num__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_examen_interface__msg__Num(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, examen_interface, msg, Num)() {
