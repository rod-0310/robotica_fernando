...
#ifndef EXAMEN_INTERFACE__SRV__DETAIL__KINEMATICS__FUNCTIONS_H_
#define EXAMEN_INTERFACE__SRV__DETAIL__KINEMATICS__FUNCTIONS_H_
...
#include "examen_interface/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_examen_interface
bool
 ...
 * calls
 * examen_interface__srv__Kinematics_Request__init().
...
/**
 * It calls
 * examen_interface__srv__Kinematics_Request__fini()
 ...
 * examen_interface__srv__Kinematics_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * examen_interface__srv__Kinematics_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * examen_interface__srv__Kinematics_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_examen_interface
...
/**
 * It calls
 * examen_interface__srv__Kinematics_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_examen_interface
...
/**
 * It allocates the memory for the array and calls
 * examen_interface__srv__Kinematics_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_examen_interface
...
/**
 * It calls
 * examen_interface__srv__Kinematics_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EXAMEN_INTERFACE__SRV__DETAIL__KINEMATICS__FUNCTIONS_H_
