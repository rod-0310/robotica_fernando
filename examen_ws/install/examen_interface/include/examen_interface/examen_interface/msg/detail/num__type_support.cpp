...
{
  new (message_memory) examen_interface::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<examen_interface::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[2] = {
  {
    ...
    offsetof(examen_interface::msg::Num, num),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(examen_interface::msg::Num, nom),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Num_message_members = {
  "examen_interface::msg",  // message namespace
  "Num",  // message name
  2,  // number of fields
  sizeof(examen_interface::msg::Num),
...
{
  return &::examen_interface::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, examen_interface, msg, Num)() {
  return &::examen_interface::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
